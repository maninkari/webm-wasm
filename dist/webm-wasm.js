...
var debug_table_ii = ["0", "__ZNK11MyMkvWriter8SeekableEv", "__ZNK17MyMkvStreamWriter8SeekableEv", "_encoder_destroy", "_encoder_get_preview", "_reset", "_sync_1485", "__ZN8mkvmuxer5Track18AddContentEncodingEv", "___stdio_close", "__ZN10emscripten8internal13getActualTypeI11WebmEncoderEEPKvPT_", "__ZN11WebmEncoder8finalizeEv", "_malloc", "_vpx_malloc", "_thread_loop", "0", "0"];
...
var debug_table_v = ["0", "___cxa_pure_virtual", "__ZL25default_terminate_handlerv", "_vp9_initialize_enc", "_setup_rtcd_internal", "_setup_rtcd_internal_725", "_setup_rtcd_internal_803", "_vp9_init_intra_predictors_internal", "__ZN10__cxxabiv112_GLOBAL__N_110construct_Ev", "0", "0", "0", "0", "0", "0", "0"];
...
function nullFunc_dd(x) { err("Invalid function pointer '" + x + "' called with signature 'dd'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: vid: " + debug_table_vid[x] + "  i: " + debug_table_i[x] + "  v: " + debug_table_v[x] + "  ii: " + debug_table_ii[x] + "  ji: " + debug_table_ji[x] + "  vi: " + debug_table_vi[x] + "  iii: " + debug_table_iii[x] + "  iij: " + debug_table_iij[x] + "  vii: " + debug_table_vii[x] + "  iiii: " + debug_table_iiii[x] + "  viii: " + debug_table_viii[x] + "  vijj: " + debug_table_vijj[x] + "  iiiii: " + debug_table_iiiii[x] + "  viiii: " + debug_table_viiii[x] + "  iiiiii: " + debug_table_iiiiii[x] + "  iiiijj: " + debug_table_iiiijj[x] + "  viiiii: " + debug_table_viiiii[x] + "  iiijiii: " + debug_table_iiijiii[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  iiiiiiiiiiiiiiiii: " + debug_table_iiiiiiiiiiiiiiiii[x] + "  "); abort(x) }

function nullFunc_i(x) { err("Invalid function pointer '" + x + "' called with signature 'i'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: ii: " + debug_table_ii[x] + "  iii: " + debug_table_iii[x] + "  iij: " + debug_table_iij[x] + "  iiii: " + debug_table_iiii[x] + "  iiiii: " + debug_table_iiiii[x] + "  iiiiii: " + debug_table_iiiiii[x] + "  iiiijj: " + debug_table_iiiijj[x] + "  iiijiii: " + debug_table_iiijiii[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  iiiiiiiiiiiiiiiii: " + debug_table_iiiiiiiiiiiiiiiii[x] + "  ji: " + debug_table_ji[x] + "  vi: " + debug_table_vi[x] + "  v: " + debug_table_v[x] + "  vid: " + debug_table_vid[x] + "  vii: " + debug_table_vii[x] + "  dd: " + debug_table_dd[x] + "  viii: " + debug_table_viii[x] + "  vijj: " + debug_table_vijj[x] + "  viiii: " + debug_table_viiii[x] + "  viiiii: " + debug_table_viiiii[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  "); abort(x) }

function nullFunc_ii(x) { err("Invalid function pointer '" + x + "' called with signature 'ii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: i: " + debug_table_i[x] + "  iii: " + debug_table_iii[x] + "  iij: " + debug_table_iij[x] + "  iiii: " + debug_table_iiii[x] + "  iiiii: " + debug_table_iiiii[x] + "  iiiiii: " + debug_table_iiiiii[x] + "  iiiijj: " + debug_table_iiiijj[x] + "  iiijiii: " + debug_table_iiijiii[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  iiiiiiiiiiiiiiiii: " + debug_table_iiiiiiiiiiiiiiiii[x] + "  vii: " + debug_table_vii[x] + "  ji: " + debug_table_ji[x] + "  vi: " + debug_table_vi[x] + "  viii: " + debug_table_viii[x] + "  vid: " + debug_table_vid[x] + "  v: " + debug_table_v[x] + "  dd: " + debug_table_dd[x] + "  viiii: " + debug_table_viiii[x] + "  vijj: " + debug_table_vijj[x] + "  viiiii: " + debug_table_viiiii[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  "); abort(x) }
...
function nullFunc_iiiiii(x) { err("Invalid function pointer '" + x + "' called with signature 'iiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: iiii: " + debug_table_iiii[x] + "  iiiii: " + debug_table_iiiii[x] + "  iii: " + debug_table_iii[x] + "  ii: " + debug_table_ii[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  i: " + debug_table_i[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  iiiiiiiiiiiiiiiii: " + debug_table_iiiiiiiiiiiiiiiii[x] + "  viiii: " + debug_table_viiii[x] + "  viii: " + debug_table_viii[x] + "  viiiii: " + debug_table_viiiii[x] + "  iij: " + debug_table_iij[x] + "  vii: " + debug_table_vii[x] + "  iiijiii: " + debug_table_iiijiii[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  iiiijj: " + debug_table_iiiijj[x] + "  ji: " + debug_table_ji[x] + "  vi: " + debug_table_vi[x] + "  vid: " + debug_table_vid[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  vijj: " + debug_table_vijj[x] + "  dd: " + debug_table_dd[x] + "  v: " + debug_table_v[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  "); abort(x) }
...
function nullFunc_iiiiiiiiiiiiiiiii(x) { err("Invalid function pointer '" + x + "' called with signature 'iiiiiiiiiiiiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: iiiii: " + debug_table_iiiii[x] + "  iiii: " + debug_table_iiii[x] + "  iiiiii: " + debug_table_iiiiii[x] + "  iii: " + debug_table_iii[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  ii: " + debug_table_ii[x] + "  i: " + debug_table_i[x] + "  viiii: " + debug_table_viiii[x] + "  viiiii: " + debug_table_viiiii[x] + "  viii: " + debug_table_viii[x] + "  iiijiii: " + debug_table_iiijiii[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  iiiijj: " + debug_table_iiiijj[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  iij: " + debug_table_iij[x] + "  vii: " + debug_table_vii[x] + "  vijj: " + debug_table_vijj[x] + "  vid: " + debug_table_vid[x] + "  ji: " + debug_table_ji[x] + "  vi: " + debug_table_vi[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  dd: " + debug_table_dd[x] + "  v: " + debug_table_v[x] + "  "); abort(x) }

function nullFunc_iiiijj(x) { err("Invalid function pointer '" + x + "' called with signature 'iiiijj'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: iiii: " + debug_table_iiii[x] + "  iii: " + debug_table_iii[x] + "  ii: " + debug_table_ii[x] + "  i: " + debug_table_i[x] + "  iij: " + debug_table_iij[x] + "  iiiii: " + debug_table_iiiii[x] + "  viiii: " + debug_table_viiii[x] + "  viii: " + debug_table_viii[x] + "  vijj: " + debug_table_vijj[x] + "  vii: " + debug_table_vii[x] + "  iiiiii: " + debug_table_iiiiii[x] + "  viiiii: " + debug_table_viiiii[x] + "  ji: " + debug_table_ji[x] + "  vi: " + debug_table_vi[x] + "  vid: " + debug_table_vid[x] + "  iiijiii: " + debug_table_iiijiii[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  dd: " + debug_table_dd[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  v: " + debug_table_v[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  iiiiiiiiiiiiiiiii: " + debug_table_iiiiiiiiiiiiiiiii[x] + "  "); abort(x) }

function nullFunc_iiijiii(x) { err("Invalid function pointer '" + x + "' called with signature 'iiijiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: iii: " + debug_table_iii[x] + "  ii: " + debug_table_ii[x] + "  i: " + debug_table_i[x] + "  iiii: " + debug_table_iiii[x] + "  iiiii: " + debug_table_iiiii[x] + "  iiiiii: " + debug_table_iiiiii[x] + "  iij: " + debug_table_iij[x] + "  viiii: " + debug_table_viiii[x] + "  ji: " + debug_table_ji[x] + "  viii: " + debug_table_viii[x] + "  viiiii: " + debug_table_viiiii[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  vii: " + debug_table_vii[x] + "  iiiijj: " + debug_table_iiiijj[x] + "  vijj: " + debug_table_vijj[x] + "  vi: " + debug_table_vi[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  vid: " + debug_table_vid[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  dd: " + debug_table_dd[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  v: " + debug_table_v[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  iiiiiiiiiiiiiiiii: " + debug_table_iiiiiiiiiiiiiiiii[x] + "  "); abort(x) }

function nullFunc_iij(x) { err("Invalid function pointer '" + x + "' called with signature 'iij'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: ii: " + debug_table_ii[x] + "  i: " + debug_table_i[x] + "  iii: " + debug_table_iii[x] + "  vii: " + debug_table_vii[x] + "  ji: " + debug_table_ji[x] + "  vi: " + debug_table_vi[x] + "  iiii: " + debug_table_iiii[x] + "  vijj: " + debug_table_vijj[x] + "  viii: " + debug_table_viii[x] + "  vid: " + debug_table_vid[x] + "  iiiii: " + debug_table_iiiii[x] + "  viiii: " + debug_table_viiii[x] + "  iiiijj: " + debug_table_iiiijj[x] + "  dd: " + debug_table_dd[x] + "  v: " + debug_table_v[x] + "  iiiiii: " + debug_table_iiiiii[x] + "  viiiii: " + debug_table_viiiii[x] + "  iiijiii: " + debug_table_iiijiii[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  iiiiiiiiiiiiiiiii: " + debug_table_iiiiiiiiiiiiiiiii[x] + "  "); abort(x) }

function nullFunc_ji(x) { err("Invalid function pointer '" + x + "' called with signature 'ji'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: i: " + debug_table_i[x] + "  ii: " + debug_table_ii[x] + "  vi: " + debug_table_vi[x] + "  iii: " + debug_table_iii[x] + "  iij: " + debug_table_iij[x] + "  vid: " + debug_table_vid[x] + "  vii: " + debug_table_vii[x] + "  v: " + debug_table_v[x] + "  dd: " + debug_table_dd[x] + "  iiii: " + debug_table_iiii[x] + "  viii: " + debug_table_viii[x] + "  vijj: " + debug_table_vijj[x] + "  iiiii: " + debug_table_iiiii[x] + "  viiii: " + debug_table_viiii[x] + "  iiiiii: " + debug_table_iiiiii[x] + "  iiiijj: " + debug_table_iiiijj[x] + "  viiiii: " + debug_table_viiiii[x] + "  iiijiii: " + debug_table_iiijiii[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  iiiiiiiiiiiiiiiii: " + debug_table_iiiiiiiiiiiiiiiii[x] + "  "); abort(x) }

function nullFunc_v(x) { err("Invalid function pointer '" + x + "' called with signature 'v'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: vi: " + debug_table_vi[x] + "  vid: " + debug_table_vid[x] + "  vii: " + debug_table_vii[x] + "  viii: " + debug_table_viii[x] + "  vijj: " + debug_table_vijj[x] + "  viiii: " + debug_table_viiii[x] + "  viiiii: " + debug_table_viiiii[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  i: " + debug_table_i[x] + "  dd: " + debug_table_dd[x] + "  ii: " + debug_table_ii[x] + "  ji: " + debug_table_ji[x] + "  iii: " + debug_table_iii[x] + "  iij: " + debug_table_iij[x] + "  iiii: " + debug_table_iiii[x] + "  iiiii: " + debug_table_iiiii[x] + "  iiiiii: " + debug_table_iiiiii[x] + "  iiiijj: " + debug_table_iiiijj[x] + "  iiijiii: " + debug_table_iiijiii[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  iiiiiiiiiiiiiiiii: " + debug_table_iiiiiiiiiiiiiiiii[x] + "  "); abort(x) }

function nullFunc_vi(x) { err("Invalid function pointer '" + x + "' called with signature 'vi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: v: " + debug_table_v[x] + "  vid: " + debug_table_vid[x] + "  vii: " + debug_table_vii[x] + "  viii: " + debug_table_viii[x] + "  vijj: " + debug_table_vijj[x] + "  viiii: " + debug_table_viiii[x] + "  viiiii: " + debug_table_viiiii[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  i: " + debug_table_i[x] + "  ii: " + debug_table_ii[x] + "  ji: " + debug_table_ji[x] + "  iii: " + debug_table_iii[x] + "  iij: " + debug_table_iij[x] + "  dd: " + debug_table_dd[x] + "  iiii: " + debug_table_iiii[x] + "  iiiii: " + debug_table_iiiii[x] + "  iiiiii: " + debug_table_iiiiii[x] + "  iiiijj: " + debug_table_iiiijj[x] + "  iiijiii: " + debug_table_iiijiii[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  iiiiiiiiiiiiiiiii: " + debug_table_iiiiiiiiiiiiiiiii[x] + "  "); abort(x) }

function nullFunc_vid(x) { err("Invalid function pointer '" + x + "' called with signature 'vid'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: vi: " + debug_table_vi[x] + "  v: " + debug_table_v[x] + "  vii: " + debug_table_vii[x] + "  i: " + debug_table_i[x] + "  ii: " + debug_table_ii[x] + "  ji: " + debug_table_ji[x] + "  dd: " + debug_table_dd[x] + "  viii: " + debug_table_viii[x] + "  vijj: " + debug_table_vijj[x] + "  iii: " + debug_table_iii[x] + "  iij: " + debug_table_iij[x] + "  viiii: " + debug_table_viiii[x] + "  iiii: " + debug_table_iiii[x] + "  viiiii: " + debug_table_viiiii[x] + "  iiiii: " + debug_table_iiiii[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  iiiiii: " + debug_table_iiiiii[x] + "  iiiijj: " + debug_table_iiiijj[x] + "  iiijiii: " + debug_table_iiijiii[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  iiiiiiiiiiiiiiiii: " + debug_table_iiiiiiiiiiiiiiiii[x] + "  "); abort(x) }
...
function nullFunc_viiiii(x) { err("Invalid function pointer '" + x + "' called with signature 'viiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("This pointer might make sense in another type signature: viii: " + debug_table_viii[x] + "  viiii: " + debug_table_viiii[x] + "  vii: " + debug_table_vii[x] + "  vi: " + debug_table_vi[x] + "  viiiiii: " + debug_table_viiiiii[x] + "  viiiiiii: " + debug_table_viiiiiii[x] + "  v: " + debug_table_v[x] + "  viiiiiiiiiii: " + debug_table_viiiiiiiiiii[x] + "  iiii: " + debug_table_iiii[x] + "  iiiii: " + debug_table_iiiii[x] + "  iii: " + debug_table_iii[x] + "  ii: " + debug_table_ii[x] + "  iiiiii: " + debug_table_iiiiii[x] + "  vid: " + debug_table_vid[x] + "  iij: " + debug_table_iij[x] + "  iiiijj: " + debug_table_iiiijj[x] + "  vijj: " + debug_table_vijj[x] + "  ji: " + debug_table_ji[x] + "  iiijiii: " + debug_table_iiijiii[x] + "  i: " + debug_table_i[x] + "  iiiiiiii: " + debug_table_iiiiiiii[x] + "  dd: " + debug_table_dd[x] + "  iiiiiiiii: " + debug_table_iiiiiiiii[x] + "  iiiiiiiiii: " + debug_table_iiiiiiiiii[x] + "  iiiiiiiiiiiiiiiii: " + debug_table_iiiiiiiiiiiiiiiii[x] + "  "); abort(x) }
